...
**UJI KOMPETENSI KEAHLIAN REKAYASA PERANGKAT LUNAK (RPL) SMK TI DWIGUNA APLIKASI PEDULI DIRI MENGGUNAKAN:**
1. TOOLS PHP, HTML, JAVASCRIPT (AJAX) DAN CSS(BOOTSTRAP)
